...
won.title("Log-In as Admin")#Title ng gui
...
LOG=Label(won, text="LOGIN" ,fg="black"  ,bg="#c4dcdf" ,font=('times', 40, ' bold ') ) 
LOG.place(x=245, y=5)

enterID=Label(won, text="Enter ID" ,fg="yellow"  ,bg="#674ea7" ,font=('times', 15, ' bold ') ) 
...
enterPASS=Label(won, text="Enter PASSWORD" ,fg="yellow"  ,bg="#674ea7" ,font=('times', 15, ' bold ') ) 
enterPASS.place(x=30, y=140)
PASSin=Entry(won,width=40  ,bg="#cccccc" ,fg="black",font=('times', 15, ' bold '), show = "*")
PASSin.place(x=220, y=140)

login = Button(won, text = " LOGIN ", font= 'Arial 16 bold', bg='#a9a9a9', fg='black')
login.place(x = 280, y = 200)

register = Button(won, text = " REGISTER ", font= 'Arial 13', bg='#a9a9a9', fg='black')
register.place(x = 30, y = 250)

CasUser = Button(won, text = " CONTINUE AS USER ", font= 'Arial 13', bg='#a9a9a9', fg='black')
CasUser.place(x = 445, y = 250)
